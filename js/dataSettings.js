    ...
    send_ajax_data(ajaxPostData, 
        function(data){
            ...
            */
            ...
            // DB9_RS232_COM1
            if (data["data"]["COM1"]["status"] == "ok") {
                console.info($("#" + data["data"]["COM1"]["name"] + "_value")); 
                $("#" + data["data"]["COM1"]["name"] + "_value").html(data["data"]["COM1"]["value"]); 
                $("#" + data["data"]["COM1"]["name"] + "_status").attr("src", "img/ok.png");
            }

            // DB9_RS232_COM2
            if (data["data"]["COM2"]["status"] == "ok") {
                console.info($("#" + data["data"]["COM2"]["name"] + "_value")); 
                $("#" + data["data"]["COM2"]["name"] + "_value").html(data["data"]["COM2"]["value"]); 
                $("#" + data["data"]["COM2"]["name"] + "_status").attr("src", "img/ok.png");
            }
            ...
            // MicroSD
            if (data["data"]["MicroSD"]["status"] == "ok") {
                console.info(data["data"]["MicroSD"]["name"] + "_value"); 
                $("#" + data["data"]["MicroSD"]["name"] + "_status").attr("src", "img/ok.png");
            }
